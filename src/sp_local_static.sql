...
-- 导出  过程 fh_xydd.sp_local_static 结构
DROP PROCEDURE IF EXISTS `sp_local_static`;
DELIMITER //
CREATE DEFINER=`fh_xyddadmin`@`%` PROCEDURE `sp_local_static`(paraId varchar(36) charset gbk,paraTime varchar(36) charset gbk,paraInterval int)
BEGIN
